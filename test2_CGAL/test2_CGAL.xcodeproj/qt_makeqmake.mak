...
test2_CGAL.xcodeproj/project.pbxproj: test2_CGAL.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/macx-xcode/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Cellar/qt/4.8.6/mkspecs/macx-xcode -o test2_CGAL.xcodeproj/project.pbxproj test2_CGAL.pro
